  ...
  return (
    <footer className="bg-brown-dark text-cream-light py-16 px-6 lg:px-12 border-t border-brown">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
        ...
        {/* Menu */}
        <div>
          <h4 className="font-serif text-lg tracking-widest uppercase mb-6 text-accent">Меню</h4>
          <ul className="space-y-4 font-sans text-sm text-cream/80">
            <li>
              <NavLink to="/catalog" className="hover:text-accent transition-colors">Каталог</NavLink>
            </li>
            <li>
              <a href="#" className="hover:text-accent transition-colors">Пасхальная коллекция</a>
            </li>
            <li>
              <a href="#" className="hover:text-accent transition-colors">Торты на заказ</a>
            </li>
            <li>
              <a href="#" className="hover:text-accent transition-colors">Подарочные наборы</a>
            </li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-cream/10 flex flex-col md:flex-row justify-between items-center text-xs text-cream/50 font-sans">
        <p>&copy; 2025 Кафе-кондитерская «Ля Рулет», г. Волгодонск. Все права защищены.</p>
        <div className="flex space-x-6 mt-4 md:mt-0">
          <a href="#" className="hover:text-cream transition-colors">Политика конфиденциальности</a>
          <a href="#" className="hover:text-cream transition-colors">Договор оферты</a>
        </div>
      </div>
    </footer>
  );
