      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-6 lg:gap-x-12">
        ...
        <div>
          ...
          <div className="flex space-x-2.5">
            {socialButtons.map(({ label, href, svg }) => (
              <a
                key={label}
                href={href}
                target="_blank"
                rel="noreferrer"
                className="w-8 h-8 rounded-full border border-cream/20 flex items-center justify-center hover:border-accent hover:text-accent transition-colors"
              >
